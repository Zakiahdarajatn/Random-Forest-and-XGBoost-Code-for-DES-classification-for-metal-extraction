...
## nama file csv disesuaikan!
Learning = pd.read_csv("C:/Users/GKlab/Documents/PENELITIAN ZAKIAH/ML/PhyTorch/Latihan/Tabular Data/DATA/descriptor for conventional metal extractant.csv") # This contains 76 ILs with non-numeric labels
### coba diurutkan sesuai metal.
...
## tulis semua nama metal, assign ke angka 12345...
## disesuaikan dengan jumlah metals
...
## kalau hasilnya jelek, coba hilangin stratify = Y
### Coba ganti2 nilai test_size = 0.05 sampe 0.3
### dari nilai terbaik, coba ganti2 random_state = 1 sampe 10
### bakal keluar yang terbaik!
...
### dari random state terbaik, ganti2 nilai cv = 5 sampe 15
...
print('Accuracy score: ', accuracy_score(Y_train, train_pred)) ## ini nilai yang paling penting (> 0.95)
...
print('Accuracy score: ', accuracy_score(Y_test, test_pred)) ## bisa sama dengan cross-validation
...
descriptors = pd.read_csv("C:/Users/GKlab/Documents/PENELITIAN ZAKIAH/ML/PhyTorch/Latihan/Tabular Data/DATA/purpose DES.csv") # This contains descriptors (features) for 150 chemicals
