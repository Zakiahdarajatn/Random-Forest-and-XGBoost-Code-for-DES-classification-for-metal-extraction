# -*- coding: utf-8 -*-
"""
Created on Mon Aug 21 14:27:00 2023
@author: GKlab
"""
...
Learning = pd.read_csv("C:/Users/GKlab/Documents/PENELITIAN ZAKIAH/ML/PhyTorch/Latihan/Tabular Data/DATA/DATA TRAINING-extractant solvent-1384 data.csv")
...
plt.xlabel('Feature', labelpad=10, fontproperties=fm.FontProperties(family='arial', size=20, weight='normal', style='normal'))
plt.ylabel('Importance', labelpad=10, fontproperties=fm.FontProperties(family='arial', size=20, weight='normal', style='normal'))
